...
TUNABLE_PARAMS = [
    ...
    {"path": ("juggle", "ground_margin_px"), "slug": "ground_margin_px",
     "min": 0, "max": 200, "step": 5, "int": False,
     "name": "Ground Margin (px)", "icon": "mdi:arrow-expand-down"},
    {"path": ("juggle", "smooth_window"), "slug": "smooth_window",
     "min": 1, "max": 15, "step": 1, "int": True,
     "name": "Smoothing Window", "icon": "mdi:chart-bell-curve"},
    {"path": ("juggle", "min_contact_gap_frames"), "slug": "min_contact_gap_frames",
     "min": 0, "max": 30, "step": 1, "int": True,
     "name": "Min Contact Gap (frames)", "icon": "mdi:timer-sand"},
